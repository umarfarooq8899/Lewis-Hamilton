  ...
  },
  {
    ...
    moments: [
      ...
      },
      {
        ...
        description: "On a treacherous, slippery surface, Hamilton delivers a masterful tire-management drive to win from 6th on the grid, clinching his 7th World Championship to equal Michael Schumacher's record.",
        statNumber: "7",
